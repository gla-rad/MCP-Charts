...
| env[11].name | string | `"MCP_LEDGER_HOST"` |  |
| env[11].valueFrom.configMapKeyRef.key | string | `"msr_ledger_host"` |  |
| env[11].valueFrom.configMapKeyRef.name | string | `"mc-service-registry-config"` |  |
| env[12].name | string | `"MCP_LEDGER_PORT"` |  |
| env[12].valueFrom.configMapKeyRef.key | string | `"msr_ledger_port"` |  |
| env[12].valueFrom.configMapKeyRef.name | string | `"mc-service-registry-config"` |  |
| env[13].name | string | `"MCP_LEDGER_ADDRESS"` |  |
| env[13].valueFrom.secretKeyRef.key | string | `"msr_ledger_address"` |  |
| env[13].valueFrom.secretKeyRef.name | string | `"mc-service-registry-secrets"` |  |
| env[14].name | string | `"MCP_LEDGER_CREDENTIALS"` |  |
