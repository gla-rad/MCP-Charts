...
| ingress.hosts[0].paths[6].serviceName | string | `"mc-mms-edge-router"` |  |
...
| ingress.hosts[0].paths[7].serviceName | string | `"mc-mms-edge-router"` |  |
| ingress.hosts[0].paths[7].servicePort | int | `9000` |  |
| ingress.name | string | `"mcp-ingress"` |  |
| ingress.plainHttpPaths[0].path | string | `"/(mir)(/x509/api/certificates/ocsp/.*)$"` |  |
| ingress.plainHttpPaths[0].pathType | string | `"ImplementationSpecific"` |  |
| ingress.plainHttpPaths[0].serviceName | string | `"mc-identity-registry"` |  |
| ingress.plainHttpPaths[0].servicePort | int | `8443` |  |
| ingress.plainHttpPaths[1].path | string | `"/(mir)(/x509/api/certificates/crl/.*)$"` |  |
| ingress.plainHttpPaths[1].pathType | string | `"ImplementationSpecific"` |  |
| ingress.plainHttpPaths[1].serviceName | string | `"mc-identity-registry"` |  |
| ingress.plainHttpPaths[1].servicePort | int | `8443` |  |
| ingress.tls | list | `[]` |  |
